...
The fundamental goal of the algorithm is to detect sharp changes in luminosity (large gradients), such as a shift from white to black, and defines them as edges, given a set of thresholds. 
The Canny algorithm has four main stages: 
1. noise reduction using a gaussian blur 
2. intensity gradient to determine orientation of edges 
3. non-maximum suppression to 'thin' and sharpen the edges 
...
'''
creates a triangular mask to segment the lane area and discard the irrelevant areas in the frame
